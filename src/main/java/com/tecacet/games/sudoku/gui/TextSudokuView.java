...
public class TextSudokuView extends JPanel implements SudokuView {
        ...
        for (int i = 0; i < 9; i++) {
            for (int j = 0; j < 9; j++) {
                ...
                if ((i % 3 == 0) && (j % 3 == 0)) {
                    ...
                    innerGrids[row][col].setBorder(BorderFactory.createLineBorder(Color.black));
     ...
     * (non-Javadoc)
     * 
     * @see org.animism.games.sudoku.gui.SudokuView#setValue(int, int, int)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.animism.games.sudoku.gui.SudokuView#clear()
     */
    public void clear() {
     ...
     * (non-Javadoc)
     * 
     * @see org.animism.games.sudoku.gui.SudokuView#refresh()
     */
    public void refresh() {
        for (int i = 0; i < game.getSize(); i++) {
            for (int j = 0; j < game.getSize(); j++) {
     ...
     * (non-Javadoc)
     * 
     * @see org.animism.games.sudoku.gui.SudokuView#clear(int, int)
     */
